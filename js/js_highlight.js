...
////		var cadena="";
////		for(i=0 ; i < 6 ; i++){
////	        cadena+='<img src="'+productos[id_seleccionado].imagenes[i]+'" alt="imag1" />';			
////		}
////		window.document.getElementById("nombre_lap").innerHTML=productos[id_seleccionado].nombre;
////		window.document.getElementById("subtitulo").innerHTML=productos[id_seleccionado].titulo;
////		window.document.getElementById("descripcion").innerHTML=productos[id_seleccionado].descripcion;
////		window.document.getElementById("grupo_imagenes").innerHTML=cadena;
